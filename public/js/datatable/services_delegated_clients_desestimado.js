...
$(document).ready(function () {
    var table = $('#deleted_clients_table').DataTable({
        pageLength : 100,
        scrollX: true,
        scroller: {
            rowHeight: 60
        ...
        ajax: '/get_deleted_clients/desestimado',
        columns: [
            {
                // Custom column
                data: 'id_lead' ,
    ...
    $('#deleted_clients_table tbody').on('click', 'td.dt-control', function () {
...
const input_checkbox_ids = document.getElementById("input_checkbox_ids");
...
function ejecutionCheckBoxIds(){
    ...
    input_checkbox_ids.innerHTML =  '<input hidden="" type="text" name="input_checkbox_ids" value="' + id_checbox + '">';
}