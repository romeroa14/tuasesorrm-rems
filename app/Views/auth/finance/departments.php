...
<div class="modal fade" id="financeModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <div class="modal-header bg-gradient-primary text-white"><h5 class="modal-title" id="modalTitle"><i class="fas fa-sitemap"></i> Departamento</h5><button type="button" class="close text-white" data-dismiss="modal">&times;</button></div>
    <form id="financeForm"><div class="modal-body"><input type="hidden" id="record_id" name="id">
        <div class="card bg-light mb-3"><div class="card-header py-2"><i class="fas fa-info-circle text-primary"></i> <strong>Información del Departamento</strong></div><div class="card-body">
            ...
            <div class="col-md-6"><div class="form-group"><label><i class="fas fa-dollar-sign text-muted"></i> Presupuesto $</label><input type="number" step="0.01" class="form-control" id="budget" name="budget" min="0"></div></div></div>
